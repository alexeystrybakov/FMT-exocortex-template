...
- **WORKPLAN.md нужен только репо с активными пользовательскими РП** (Pack, DS-governance). Инструментальные репо (DS instrument) — не нужен: платформенная работа управляется через governance-хаб.
