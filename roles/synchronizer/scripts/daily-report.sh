...
LOG_DIR="/home/alexey/logs/synchronizer"
STRATEGY_DIR="/home/alexey/IWE/DS-strategy"
...
STRATEGIST_LOG="/home/alexey/logs/strategist/$DATE.log"
...
"
        if echo "$warnings" | grep -q "push failed" 2>/dev/null; then
            report+="- **push failed:** Mac был оффлайн. Запусти \`cd /home/alexey/IWE/DS-strategy && git pull --rebase && git push\`
"
        fi
    else
        report+="
