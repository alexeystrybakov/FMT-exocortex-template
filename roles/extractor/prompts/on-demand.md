...
> 1. `/home/alexey/IWE/DS-exocortex/roles/extractor/config/routing.md` — таблицы маршрутизации
> 2. `/home/alexey/IWE/DS-exocortex/roles/extractor/config/feedback-log.md` — лог отклонённых кандидатов
