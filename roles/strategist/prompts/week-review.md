...
- **WeekPlan:** /home/alexey/IWE/DS-strategy/current/WeekPlan W*.md
...
git -C /home/alexey/IWE/<repo> log --since="last monday 00:00" --until="today 00:00" --oneline --no-merges
```
...
> Проверь: существует ли директория `/home/alexey/IWE/DS-Knowledge-Index-alexeystrybakov/`?
> Если нет — пропусти шаг 6 полностью.

1. Переключись на **роль Автора (R4)** и на основе WeekReport сформируй пост для клуба.

   **Обязательно прочитай** `/home/alexey/IWE/DS-Knowledge-Index-alexeystrybakov/CLAUDE.md` — полные инструкции роли Автора:
...
2. Создай файл `/home/alexey/IWE/DS-Knowledge-Index-alexeystrybakov/docs/{YYYY}/{YYYY-MM-DD}-week-review-w{N}.md`
...
4. Обнови `/home/alexey/IWE/DS-Knowledge-Index-alexeystrybakov/docs/README.md` — добавь строку в начало текущего месяца
