...
Каждый репозиторий в `/home/alexey/IWE/` содержит `WORKPLAN.md` в корне с текущими РП.

**Агрегация:** При создании плана дня/недели Стратег:
1. Обходит все `/home/alexey/IWE/*/WORKPLAN.md`
...
for repo in $(ls /home/alexey/IWE/); do
  if [ -d /home/alexey/IWE/$repo/.git ]; then
    echo "=== $repo ===" && cd /home/alexey/IWE/$repo && git log --oneline --since="1 week ago" 2>/dev/null
  fi
done
```
...
> **Полное описание:** `/home/alexey/IWE/CLAUDE.md` секция 2.
