...
Рабочая директория: `/home/alexey/IWE/` (не из sub-директорий). `/home/alexey/IWE/memory/` = симлинк на auto-memory.
...
- `/home/alexey/IWE/` — рабочая директория
